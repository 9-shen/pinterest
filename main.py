...
title_font_cut = 30
post_font_size = 30
rectangle_color_1 = '#83A2FF'
rectangle_color_2 = '#A6CF98'
rectangle_radius = 30
ellipse_color_1 = '#FFC436'
ellipse_color_2 = '#F05941'
bottom_section = True
#bottom_text = '🔥 All-in-one Solution In The Bio Link ➡️ 🔥'
bottom_text = '🔥 Find More www.tasty-recipes.co ➡️ 🔥'
...
def open_data(folder_name):
    file_path = READY / folder_name / 'data2.csv'
